...
EvalString("Select (2) Case (1) Do (Debug 'Select is NOT 1.') Case (2) Do (Debug 'Select is 2.') Default Do (Debug 'Select is NOT none.')")
EvalString("Select (1) Case (1) Do (Debug 'Select is 1.') Case (2) Do (Debug 'Select is NOT 2.')")
EvalString("Select (5) Case (1) Do (Debug 'Select is NOT 1.') Case (2) Do (Debug 'Select is NOT 2.') Default Do (Debug 'Select is none.')")
